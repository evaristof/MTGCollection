...
class CollectionCardServiceUpdateDeleteTest {
    ...
    void update_changesMutableFields() {
        ...
        CollectionCard updated = service.update(10L, null, null, true, "pt", 4);
    ...
    void update_canOverrideNameAndSet() {
        ...
        CollectionCard updated = service.update(10L, "Bolt Alt Art", "other", false, "en", 2);
    ...
    void update_rejectsInvalidArguments() {
        when(repository.findById(10L)).thenReturn(Optional.of(existing()));
        assertThatThrownBy(() -> service.update(10L, null, null, false, " ", 1))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> service.update(10L, null, null, false, "en", 0))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void update_throwsWhenMissing() {
        ...
        assertThatThrownBy(() -> service.update(42L, null, null, false, "en", 1))
                .isInstanceOf(NoSuchElementException.class);
    }
